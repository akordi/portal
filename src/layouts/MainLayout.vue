  ...
  <div>
    <div>
      <LxShell :system-name="$t('title.fullName')" :system-subheader="$t('title.subheader')"
        ...
        :has-alerts="false" :has-help="false" :has-theme-picker="true" :hideHeaderText="!viewStore?.isHeaderShown"
        ...
        v-model:notifications="notify.notifications" @confirmModalClosed="confirmModalClosed" @go-home="goHome"
        @go-back="goBack" @log-out="openConfirmModal" @idleModalPrimary="idleModalPrimary"
